...
const MainSlider = () => {
  return (
    <Box sx={{ position:"relativ" width: "940px", mt: 3 }}>
      ...
      <ArrowBackIosIcon sx={{ position:"absolute", color: grey[100], left: 0 }} />
      <ArrowForwardIosIcon sx={{ position:"absolute", color: grey[100], right: 0 }} />
    </Box>
  );
};
