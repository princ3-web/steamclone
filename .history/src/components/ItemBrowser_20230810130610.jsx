    ...
    <Box sx={{ mt: 4 }}>
      ...
      >
        ...
        >
          ...
          <Box sx={{backgroundColor: blueGrey}}>
            <Typography color={blueGrey[900]} variant="subtitle4">Ogólne recenzje użytkowników</Typography>
            <Typography color={blueGrey[900]} variant="subtitle4">W większości pozytywne (419)</Typography>
          </Box>
          <Box>
