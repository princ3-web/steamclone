...
const Sidebar = () => {
  ...
  return (
    <Box sx={{ display: "flex", flexDirection: "column", width: "287px", height: "100vh", alignItems:"space-between" }}>
      {items.map((item) => (
        <Box sx={{ display: "flex", flexDirection: "column", mb: 2, backgroundColor:"red", boxSizing:"border-box", paddingLeft: "50px"}}>
