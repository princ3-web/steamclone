...
const MainSlider = () => {
  return (
    <Box sx={{ position:"relative", width: "940px", mt: 3, border: "2px solid red" }}>
      ...
      <ArrowBackIosIcon sx={{ position:"absolute", color: grey[100], left: -40, fontSize: 50, top: "50%" }} />
      <ArrowForwardIosIcon sx={{ position:"absolute", color: grey[100], right: -40, fontSize: 50, top: "50%" }} />
    </Box>
  );
};
