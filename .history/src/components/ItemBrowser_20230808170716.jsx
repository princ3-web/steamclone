...
const ItemBrowser = () => {
  ...
  return (
    <Box sx={{ my: 4 }}>
      ...
      <Box><Typography>qweqwe</Typography></Box>
      <Box sx={{ backgroundColor: blueGrey[700], width: 940, height: 814, pt: 3 }}>
        {elements.map(item => 
          <Box sx={{ display: "flex", height: "69px", width: "618px", mb: 1, backgroundColor: blueGrey[900] }}>
            <CardMedia
              component="img"
              image={image}
              alt="Sample Image"
