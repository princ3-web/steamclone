...
const MainSlider = () => {
  return (
    <Box sx={{ position: "relative", width: "940px", mt: 3 }}>
      ...
      <ArrowBackIosIcon
        sx={{ position: "absolute", color: grey[100], left: -60, fontSize: 50, top: "50%", border: "1px solid red" }}
      />
      </Box>
      
      <ArrowForwardIosIcon
        sx={{ position: "absolute", color: grey[100], right: -60, fontSize: 50, top: "50%", border: "1px solid red" }}
      />
    </Box>
  );
};
