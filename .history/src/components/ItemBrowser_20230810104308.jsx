...
const ItemBrowser = () => {
  ...
  const items = ["1", "Bestsellery", "Popularne nadchodzące", "Oferty specjalne"];
      ...
      <Box sx={{ display: "flex" }}>
        {items.map((item, n) => (
          <Box
            ...
            sx={{ p: 1, backgroundColor: selectedCategory === n ? blueGrey[700] : blueGrey[800], borderTopLeftRadius: 2, borderTopRightRadius: 2 }}
          >
            <Typography
              sx={{
                cursor: "pointer",
