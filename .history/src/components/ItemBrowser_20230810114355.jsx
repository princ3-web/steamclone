...
const ItemBrowser = () => {
  ...
  return (
    <Box sx={{ mt: 4 }}>
      ...
      <Box sx={{ backgroundColor: blueGrey[700], background: "linear-gradient(to bottom," + blueGrey[900] + "," + blueGrey[800] + ")", width: "100vw", height: 814, pt: 1, px: "287px" }}>
        <Box sx={{ backgroundColor: blueGrey[900], width: "619px", py: 1, textAlign: "end" }}>
