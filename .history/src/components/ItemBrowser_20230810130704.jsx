  ...
  return (
    <Box sx={{ mt: 4 }}>
      ...
      >
        ...
        >
          <Box>
            <Typography color={blueGrey[900]} variant="h6">Stray Gods: The Roleplaying</Typography>
          </Box>
          <Box sx={{display:"flex"mbackgroundColor: blueGrey[700]}}>
            <Typography color={blueGrey[100]} variant="subtitle4">Ogólne recenzje użytkowników</Typography>
            <Typography color={blue[500]} variant="subtitle4">W większości pozytywne (419)</Typography>
          </Box>
          <Box>
