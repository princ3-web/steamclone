    ...
    <Box sx={{ position: "relative", width: "940px", mt: 3 }}>
      ...
      <Box display={"flex"} sx={{ height: "353px" }} backgroundColor={blueGrey[400]}>
        ...
        >
          ...
          <Box color={grey[100]} mx={2} sx={{display:"flex"}}>
          {items[selectedSlide].tags.map(item => <Typography variant="subtitle3" sx={{px: 2, py: 1, backgroundColor: blueGrey[200]}}>{item}</Typography>)}
          </Box>
