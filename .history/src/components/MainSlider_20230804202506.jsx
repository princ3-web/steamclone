...
const MainSlider = () => {
  return (
    <Box sx={{ position:"relative", width: "940px", mt: 3 }}>
      ...
      <ArrowBackIosIcon sx={{ position:"absolute", color: grey[100], left: -50, fontSize: 40, top: 50%" }} />
      <ArrowForwardIosIcon sx={{ position:"absolute", color: grey[100], right: -50, fontSize: 40, top: "50%" }} />
    </Box>
  );
};
