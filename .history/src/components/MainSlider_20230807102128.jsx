...
const MainSlider = () => {
  return (
    <Box sx={{ position: "relative", width: "940px", mt: 3 }}>
      ...
      <ArrowBackIosIcon
        sx={{ position: "absolute", color: grey[100], left: -0, fontSize: 50, top: "50%", border: "1px solid red" }}
      />
      <ArrowForwardIosIcon
        sx={{ position: "absolute", color: grey[100], right: -150, fontSize: 50, top: "50%", border: "1px solid red" }}
      />
    </Box>
  );
};
