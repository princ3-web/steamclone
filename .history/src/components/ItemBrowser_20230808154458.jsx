    ...
    <Box sx={{ my: 4 }}>
      ...
      <Box sx={{ backgroundColor: blueGrey[700], width: 940, height: 814 }}>
        <Box sx={{display:"flex", height: "69px"}}>
          ...
          />
          <Box sx={{display: "flex", flexDirection:"column"mx: 2, justifyContent:"space-between"}}>
            <Typography variant="subtitle1" color={grey[400]}>Baldur's Gate 3</Typography>
            <Typography variant="subtitle3" color={grey[600]}>bbb</Typography>
          </Box>
        </Box>
      </Box>
    </Box>
