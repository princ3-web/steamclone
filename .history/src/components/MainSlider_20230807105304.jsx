    ...
    <Box sx={{ position: "relative", width: "940px", mt: 3 }}>
      ...
      <Box
        sx={{
          ...
          background: "linear-gradient(to right," + blueGrey[800] + "," + blueGrey[600] + ")",
          height: "108px",
          width: "45px",
        }}
      >
        <ArrowBackIosNewIcon sx={{ fontSize: 45, fontWeight: 900 }} />
      </Box>
      <Box
        sx={{
          display: "flex",
          ...
          top: "50%",
          transform: "translate(0%, -50% )",
          background: "linear-gradient(to left," + blueGrey[800] + "," + blueGrey[600] + ")",
          height: "108px",
          width: "45px",
        }}
      >
        <ArrowForwardIosIcon sx={{ fontSize: 45, fontWeight: 900 }} />
      </Box>
    </Box>
  );
};
